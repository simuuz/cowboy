...
void Cpu::execute(byte opcode) {
    switch(opcode) {
        case 0: break;                                //NOP
        case 0x01: case 0x11: case 0x21: case 0x31:   //LD r16, half
        ...
        case 0x0e: case 0x1e: case 0x2e: case 0x3e:   //LD r8, byte
        ...
        halt = true;
        break;
        case 0xc4: case 0xd4: case 0xcc: case 0xdc: case 0xcd: { //CALL cond half
        ...
        break;
        case 0xc2: case 0xd2: case 0xca: case 0xda: case 0xc3: { //JP cond half
            half addr = bus.next_half(regs.pc, regs.pc);
            if(cond(opcode)) {
                regs.pc = addr;
                cycles += 4;
        ...
        break;
        case 0x20: case 0x30: case 0x28: case 0x38: { //JR cond sbyte
