...
constexpr char* opcode_disasm[256] =
{
  ...
  "RET NC",         "POP DE",      "JP NC, %04X",    "INVALID",    "CALL NC, %04X", "PUSH DE",    "SUB A, %02X",   "RST 10h",    "RET C",            "RETI",       "JP C, %04X",   "INVALID",   "CALL C, %04X", "INVALID",   "SBC A, %02X", "RST 18h",
  "LD (FF%02X), A", "POP HL",      "LD (FF00+C), A", "INVALID",    "INVALID",       "PUSH HL",    "AND A, %02X",   "RST 20h",    "ADD SP, %02X",     "JP HL",      "LD (%04X), A", "INVALID",   "INVALID",      "INVALID",   "XOR A, %02X", "RST 28h",
