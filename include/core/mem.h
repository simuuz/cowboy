...
const int BOOTROM_SZ = 0x100;
const int EXTRAM_SZ = 0x2000;
const int ERAM_SZ = 0x1e00;
const int WRAM_SZ = 0x2000;
const int HRAM_SZ = 0x7f;
const int ROM_SZ_MIN = 0x8000;
...
typedef struct _mem_t {
    ...
    mbc5_t mbc5;
    mem_io io;
    uint8_t ie, *rom, MBC, ROM_SIZE, RAM_SIZE;
